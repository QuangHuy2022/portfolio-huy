...
const projects = [
  ...
  },
  {
    ...
    features: [
      "AI Gameplay Mode: Developed an AI using the Minimax algorithm with Alpha-Beta Pruning to optimize calculation speed. The AI is set to 3 difficulty levels (Easy, Medium, Hard) based on search depth and evaluation function.",
      "Online (P2P) Play Mode: Integrated WebRTC technology (via PeerJS) to establish direct peer-to-peer connections between browsers. Players can create rooms and share IDs to compete without needing an intermediary server, minimizing latency.",
      "Complex Game Logic: Implemented the complete rule set and game logic for Go and Xiangqi (Chinese Chess), handling special cases like captures, scoring, checks and checkmates, and game end.",
      "Responsive UI: Designed a modern, minimalist UI/UX that works well on various screen sizes using Tailwind CSS.",
    ],
    skills: [
      "Proficient in building large-scale web applications with TypeScript, ensuring type safety.",
      "Deep understanding of data structures and algorithms in game development (Tree search, Recursive algorithms).",
      "Practical experience with WebRTC and real-time communication handling.",
      "Skilled in optimizing React component performance to ensure smooth gameplay experience.",
    ],
  },
  {
    ...
    points: [],
    features: [
      "Interactive 3D Interface: Used Three.js and React Three Fiber to create dynamic 3D models (Computer, Earth, Stars).",
      "Smooth Animations: Integrated Framer Motion for smooth entrance, hover, and scroll transitions.",
      "Dark Mode & Responsive: Designed a modern dark theme interface optimized for display on all devices from mobile to desktop.",
      "Portfolio Showcase: Professional system for displaying projects, certificates, and blog posts.",
    ],
    skills: [
      "Basic 3D graphics programming on the web with Three.js.",
      "Building modern UI/UX with Tailwind CSS.",
      "Managing state and component lifecycle in React.",
      "Rendering performance optimization for complex 3D components.",
    ],
  },
  {
    ...
    points: [],
    features: [
      "Product & Category Management: Complete CRUD system for Admin to manage inventory and categorization.",
      "User Authentication: Integrated ASP.NET Core Identity to manage accounts, login, and user role-based authorization.",
      "Shopping Cart & Checkout: Built the complete purchase flow from adding products to cart to order confirmation.",
      "System Administration: Admin dashboard to monitor revenue and order status.",
    ],
    skills: [
      "Strong grasp of MVC pattern in web application development with ASP.NET Core.",
      "Designing and querying relational databases with SQL Server and Entity Framework Core.",
      "Building basic authorization and security systems for web applications.",
      "Working with Razor Pages and handling data from server to client.",
    ],
  },
  {
    ...
    points: [],
    features: [
      "Real-time Multiplayer: Used SignalR to transmit game moves instantly between two players.",
      "Lobby System: Allowed players to create rooms and join existing ones through an online list.",
      "In-game Chat: Integrated an in-game chat box for players to communicate in real time.",
      "AI Bot: Integrated the Minimax algorithm to let players practice against the AI when no opponent is available.",
    ],
    skills: [
      "Handling real-time data transmission with WebSockets/SignalR.",
      "Effectively combining ASP.NET Core backend with ReactJS frontend.",
      "Building board game logic and synchronized win/loss state management.",
      "Designing highly interactive gaming interfaces.",
    ],
  },
  {
    ...
    points: [],
    features: [
      "Online Music Player: Built a music player supporting Play/Pause, Next/Prev, volume adjustment, and progress bar.",
      "Playlist Management: Allowed users to create, edit, and manage personal favorite song lists.",
      "Smart Search: Quick searching for songs, artists, and albums from SQL Server database.",
      "Optimized UI: Designed an interface inspired by modern streaming platforms, focused on user experience.",
    ],
    skills: [
      "Handling multimedia (audio) files on web platforms.",
      "Managing complex relational data between Songs, Artists, and Playlists.",
      "Using Tailwind CSS to quickly build complex interfaces.",
      "Organizing codebase in MVC pattern for easy maintenance.",
    ],
  },
  {
    ...
    points: [],
    features: [
      "RESTful API: Built standard APIs for information management applications.",
      "Stream Processing: Leveraged the Java Stream API to efficiently process and filter data.",
      "Socket Programming: Developed basic chat applications and file transfer via TCP/IP protocol.",
      "Memory Management: Deep understanding of Java memory management, JVM, and multithreading.",
    ],
    skills: [
      "Proficient in Java language and new features in Java 8+.",
      "Building enterprise applications with Spring Boot framework.",
      "Network programming and socket connection handling.",
      "Algorithm and data structure optimization in Java.",
    ],
  },
];
...
const testimonials = [
  {
    testimonial:
      "“Success is not the destination, but the journey of constant effort every day.”",
    name: "Nguyễn Hiến",
  ...
  {
    testimonial:
      "“Don't be afraid of failure. Failure is just an opportunity to start again more intelligently.”",
    name: "Henry Ford",
    designation: "Founder",
...
const certificates = [
  {
    ...
    date: "2024",
    description: "English language proficiency certificate at B2 level, skilled in listening, speaking, reading, and writing.",
    tags: [
  ...
  },
  {
    ...
    date: "2024",
    description: "Set of specialized certificates from Google on AI foundations, source control with Git/GitHub, and Agile Project Management.",
    tags: [
  ...
  },
  {
    ...
    date: "2024",
    description: "Completed the famous CS50 computer science course, specializing in Python and SQL database management.",
    tags: [
  ...
  },
  {
    ...
    issuer: "IBM",
    date: "2024",
    description: "Specialized certificate in NoSQL database management systems (MongoDB, Cassandra, etc.)",
    tags: [
  ...
  },
  {
    ...
    issuer: "Microsoft",
    date: "2024",
    description: "International MOS office productivity certificates for Word and Excel.",
    tags: [
  ...
  },
  {
    ...
    issuer: "Udemy",
    date: "2024",
    description: "Completed a deep-dive course on Data Structures and Algorithms using C/C++.",
    tags: [
