...
const projects = [
  {
    ...
    iconBg: "#383E56",
    date: "2024 - Present",
    points: [], // Xóa mô tả ngắn
    link: "https://covua-ai.vercel.app/",
    features: [
      "Chế độ chơi với AI: Phát triển trí tuệ nhân tạo sử dụng thuật toán Minimax kết hợp Alpha-Beta Pruning để tối ưu hóa tốc độ tính toán. AI được thiết lập với 3 cấp độ (Dễ, Trung bình, Khó) dựa trên độ sâu tìm kiếm và hàm lượng giá (Evaluation Function).",
      "Chế độ chơi Online (P2P): Tích hợp công nghệ WebRTC (thông qua PeerJS) để thiết lập kết nối trực tiếp giữa hai trình duyệt. Người chơi có thể tạo phòng và gửi mã ID để thi đấu mà không cần thông qua server trung gian, giúp giảm thiểu độ trễ (latency).",
      "Logic Game phức tạp: Tự triển khai bộ quy tắc và logic cho Cờ Vây (Go) và Cờ Tướng (Xiangqi), xử lý các trường hợp đặc biệt như ăn quân, tính điểm, chiếu tướng và kết thúc trận đấu.",
      "Giao diện Responsive: Thiết kế UI/UX hiện đại, tối giản và tương thích tốt trên nhiều kích thước màn hình bằng Tailwind CSS.",
    ],
    skills: [
      "Thành thạo việc xây dựng ứng dụng Web quy mô lớn với TypeScript, đảm bảo tính chặt chẽ về dữ liệu (Type-safety).",
      "Hiểu sâu về cấu trúc dữ liệu và giải thuật trong lập trình game (Tree search, Recursive algorithms).",
      "Kinh nghiệm thực tế với WebRTC và xử lý kết nối thời gian thực (Real-time communication).",
      "Kỹ năng tối ưu hóa hiệu suất React component để đảm bảo trải nghiệm chơi mượt mà.",
    ],
  },
  {
    ...
    points: [],
    features: [
      "Giao diện 3D tương tác: Sử dụng Three.js và React Three Fiber để tạo các mô hình 3D sinh động (Máy tính, Trái đất, Các vì sao).",
      "Hiệu ứng mượt mà: Tích hợp Framer Motion cho các chuyển động xuất hiện, hover và scroll mượt mà.",
      "Dark Mode & Responsive: Thiết kế giao diện tối hiện đại, tối ưu hóa hiển thị trên mọi thiết bị từ di động đến desktop.",
      "Portfolio Showcase: Hệ thống hiển thị dự án, chứng chỉ và bài viết blog chuyên nghiệp.",
    ],
    skills: [
      "Lập trình đồ họa 3D cơ bản trên Web với Three.js.",
      "Xây dựng UI/UX hiện đại với Tailwind CSS.",
      "Quản lý trạng thái và vòng đời component trong React.",
      "Tối ưu hóa hiệu năng render cho các thành phần 3D phức tạp.",
    ],
  },
  {
    ...
    points: [],
    features: [
      "Quản lý sản phẩm & Danh mục: Hệ thống CRUD hoàn chỉnh cho Admin quản lý kho hàng và phân loại.",
      "Xác thực người dùng: Tích hợp ASP.NET Core Identity để quản lý tài khoản, đăng nhập và phân quyền người dùng.",
      "Giỏ hàng & Thanh toán: Xây dựng luồng mua hàng từ thêm sản phẩm vào giỏ đến xác nhận đơn hàng.",
      "Quản trị hệ thống: Dashboard dành cho Admin theo dõi doanh thu và tình trạng đơn hàng.",
    ],
    skills: [
      "Nắm vững mô hình MVC trong phát triển ứng dụng Web với ASP.NET Core.",
      "Thiết kế và truy vấn cơ sở dữ liệu quan hệ với SQL Server và Entity Framework Core.",
      "Xây dựng hệ thống phân quyền và bảo mật cơ bản cho Web.",
      "Làm việc với Razor Pages và xử lý dữ liệu từ Server xuống Client.",
    ],
  },
  {
    ...
    points: [],
    features: [
      "Real-time Multiplayer: Sử dụng SignalR để truyền tải dữ liệu nước đi ngay lập tức giữa hai người chơi.",
      "Hệ thống phòng chờ: Cho phép người chơi tạo phòng, tham gia phòng có sẵn thông qua danh sách trực tuyến.",
      "Chat trực tuyến: Tích hợp khung chat trong trận đấu để người chơi tương tác thời gian thực.",
      "AI Bot: Tích hợp thuật toán Minimax cho phép người chơi luyện tập với máy khi không có đối thủ.",
    ],
    skills: [
      "Xử lý truyền tải dữ liệu thời gian thực với WebSockets/SignalR.",
      "Kết hợp Backend ASP.NET Core với Frontend ReactJS một cách hiệu quả.",
      "Xây dựng logic trò chơi bàn cờ và xử lý trạng thái thắng/thua đồng bộ.",
      "Thiết kế giao diện chơi game tương tác cao.",
    ],
  },
  {
    ...
    points: [],
    features: [
      "Trình phát nhạc trực tuyến: Xây dựng trình phát nhạc hỗ trợ Play/Pause, Next/Prev, điều chỉnh âm lượng và thanh tiến trình.",
      "Quản lý Playlist: Cho phép người dùng tạo, chỉnh sửa và quản lý danh sách bài hát yêu thích cá nhân.",
      "Tìm kiếm thông minh: Tìm kiếm bài hát, nghệ sĩ và album nhanh chóng từ cơ sở dữ liệu SQL Server.",
      "Giao diện tối ưu: Thiết kế UI lấy cảm hứng từ các nền tảng streaming hiện đại, tập trung vào trải nghiệm người dùng.",
    ],
    skills: [
      "Xử lý các tập tin đa phương tiện (audio) trên nền tảng Web.",
      "Quản lý dữ liệu quan hệ phức tạp giữa Bài hát, Nghệ sĩ và Playlist.",
      "Sử dụng Tailwind CSS để xây dựng giao diện phức tạp một cách nhanh chóng.",
      "Tổ chức mã nguồn theo mô hình MVC để dễ dàng bảo trì.",
    ],
  },
  {
    ...
    points: [],
    features: [
      "RESTful API: Xây dựng các API chuẩn cho các ứng dụng quản lý thông tin.",
      "Xử lý luồng (Streams): Sử dụng mạnh mẽ Java Stream API để xử lý và lọc dữ liệu hiệu quả.",
      "Socket Programming: Phát triển ứng dụng chat cơ bản và truyền tải file qua giao thức TCP/IP.",
      "Quản lý bộ nhớ: Hiểu sâu về cách Java quản lý bộ nhớ, JVM và xử lý đa luồng (Multithreading).",
    ],
    skills: [
      "Thành thạo ngôn ngữ Java và các tính năng mới trong Java 8+.",
      "Xây dựng ứng dụng doanh nghiệp với Spring Boot framework.",
      "Lập trình mạng và xử lý kết nối Socket.",
      "Tối ưu hóa thuật toán và cấu trúc dữ liệu trong Java.",
    ],
  },
];
...
const certificates = [
  {
    ...
    date: "2024",
    description: "Chứng chỉ tiếng Anh học thuật đạt trình độ B2, thành thạo các kỹ năng nghe, nói, đọc, viết.",
    tags: [
      { name: "English", color: "blue-text-gradient" },
      { name: "IELTS", color: "green-text-gradient" },
    ],
    image: "/certificates/JSE1.png", // Giữ nguyên ảnh cũ làm placeholder
    detail_image: "/certificates/js1.png",
    verification_link: "#",
  },
  {
    name: "Google: AI Fundamentals, Git & GitHub, Agile",
    issuer: "Google / Coursera",
    date: "2024",
    description: "Bộ chứng chỉ chuyên sâu của Google về nền tảng AI, quản lý mã nguồn với Git/GitHub và quy trình Agile Project Management.",
    tags: [
      { name: "Google", color: "orange-text-gradient" },
  ...
  {
    name: "Harvard CS50: Python, SQL",
    issuer: "Harvard University",
    date: "2024",
    description: "Hoàn thành khóa học khoa học máy tính CS50 nổi tiếng, chuyên sâu về ngôn ngữ Python và quản trị cơ sở dữ liệu SQL.",
    tags: [
      { name: "Harvard", color: "red-text-gradient" },
      { name: "CS50", color: "yellow-text-gradient" },
  ...
  {
    name: "IBM: NoSQL Databases",
    issuer: "IBM",
    date: "2024",
    description: "Chứng chỉ chuyên môn về các hệ quản trị cơ sở dữ liệu NoSQL (MongoDB, Cassandra, v.v.)",
    tags: [
      { name: "IBM", color: "blue-text-gradient" },
      { name: "NoSQL", color: "green-text-gradient" },
    ],
  ...
  {
    name: "Microsoft: MOS Word, MOS Excel",
    issuer: "Microsoft",
    date: "2024",
    description: "Chứng chỉ tin học văn phòng quốc tế MOS cho hai công cụ Word và Excel.",
    tags: [
      { name: "Microsoft", color: "blue-text-gradient" },
      { name: "MOS", color: "orange-text-gradient" },
    ],
    image: "/certificates/JSE2.png",
    detail_image: "/certificates/js2.png",
    verification_link: "#",
  ...
  {
    name: "Udemy: Data Structures & Algorithms in C/C++",
    issuer: "Udemy",
    date: "2024",
    description: "Hoàn thành khóa học chuyên sâu về Cấu trúc dữ liệu và Giải thuật sử dụng ngôn ngữ C/C++.",
    tags: [
      { name: "Udemy", color: "purple-text-gradient" },
      { name: "DSA", color: "blue-text-gradient" },
      { name: "C/C++", color: "green-text-gradient" },
    ],
    image: "/certificates/NWB.png",
    detail_image: "/certificates/network.png",
    verification_link: "#",
